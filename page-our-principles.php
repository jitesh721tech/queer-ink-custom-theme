<?php
/**
 * Template for the "Our Principles" page.
 * Matched automatically by the WordPress template hierarchy for the
 * page with slug "our-principles" — no manual template assignment
...
<main id="site-content" class="site-content container" role="main">
    ...
    while ( have_posts() ) :
        ...
        get_template_part( 'template-parts/content-page-boxed', null, array(
            'back_url'   => home_url( '/archiving/' ),
            'back_label' => esc_html__( 'Back to Archiving', 'queer-ink-theme' ),
        ) );
    endwhile;
    ?>
</main>
